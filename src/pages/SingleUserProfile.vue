      ...
      <div class="relative px-4 sm:px-6 pb-8">
        ...
        <div class="-mt-16 mb-6 sm:mb-3">
          ...
          >
            ...
            <div class="flex space-x-2 sm:mb-2">
              <button
                class="p-1.5 shrink-0 rounded border border-gray-200 hover:border-gray-300 shadow-sm"
              >
                <svg
                  class="w-4 h-1 fill-current text-gray-400"
                  viewBox="0 0 16 4"
                >
              ...
              >
                ...
                >
                  <path
                    d="m.457 4.516.969-.99 2.516 2.481L9.266.702l.985.99-6.309 6.284z"
                  />
                </svg>
        ...
        <header class="text-center sm:text-left mb-6">
          ...
          <div class="inline-flex items-start mb-2">
            ...
            <svg
              class="w-4 h-4 fill-current shrink-0 text-yellow-500 ml-2"
              viewBox="0 0 16 16"
            >
              <path
          ...
          <div class="flex flex-wrap justify-center sm:justify-start space-x-4">
            <div class="flex items-center">
              <svg
                class="w-4 h-4 fill-current shrink-0 text-gray-400"
                viewBox="0 0 16 16"
              >
                <path
              ...
              <span
                class="text-sm font-medium whitespace-nowrap text-gray-500 ml-2"
                >Milan, IT</span
              >
            </div>
            <div class="flex items-center">
        ...
        <div class="relative mb-6">
          ...
          >
            ...
            >
              <a
                class="block pb-3 text-indigo-500 whitespace-nowrap border-b-2 border-indigo-500"
                href="#0"
                >General</a
              >
            </li>
            ...
            >
              <a
                class="block pb-3 text-gray-500 hover:text-gray-600 whitespace-nowrap"
                href="#0"
                >Connections</a
              >
            </li>
          ...
          <div class="space-y-5 mb-8 xl:mb-0">
            ...
            <div>
              ...
              <div class="grid xl:grid-cols-2 gap-4">
                <!-- Card -->
                <div
                  class="bg-white p-4 border border-gray-200 rounded-sm shadow-sm"
                >
                  <!-- Card header -->
                ...
                <ul class="space-y-3">
                  ...
                  <li class="sm:flex sm:items-center sm:justify-between">
                    <div class="sm:grow flex items-center text-sm">
                      <!-- Icon -->
                      <div
                        class="w-8 h-8 rounded-full shrink-0 bg-yellow-500 my-2 mr-3"
                      >
                        <svg
                          class="w-8 h-8 fill-current text-yellow-50"
                          viewBox="0 0 32 32"
                        >
                          <path
                      ...
                      <div>
                        ...
                        <div
                          class="flex flex-nowrap items-center space-x-2 whitespace-nowrap"
                        >
                          <div>Remote</div>
                    ...
                    <div class="sm:ml-2 mt-2 sm:mt-0">
                      <ul class="flex flex-wrap sm:justify-end -m-1">
                        <li class="m-1">
                          <button
                            class="inline-flex items-center justify-center text-xs font-medium leading-5 rounded-full px-2.5 py-0.5 border border-gray-200 hover:border-gray-300 shadow-sm bg-white text-gray-500 duration-150 ease-in-out"
                          >
                            Marketing
                          </button>
                        </li>
                  ...
                  <li class="sm:flex sm:items-center sm:justify-between">
                    <div class="sm:grow flex items-center text-sm">
                      <!-- Icon -->
                      <div
                        class="w-8 h-8 rounded-full shrink-0 bg-indigo-500 my-2 mr-3"
                      >
                        <svg
                          class="w-8 h-8 fill-current text-indigo-50"
                          viewBox="0 0 32 32"
                        >
                          <path
