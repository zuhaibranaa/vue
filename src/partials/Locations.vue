<template>
  <div id="locations" class="container my-24 px-6 mx-auto">
    <section class="mb-32 text-gray-800 text-center lg:text-left">
      <h2 class="text-3xl font-bold mb-12 text-center">Coverage Locations</h2>
      ...
      <div class="grid lg:grid-cols-3 gap-x-6">
        ...
        <div class="mb-12 lg:mb-0">
          ...
          <div
            class="mb-3 text-blue-600 font-medium text-sm flex items-center justify-center lg:justify-start"
          >
            <svg
              class="w-4 h-4 mr-2"
              xmlns="http://www.w3.org/2000/svg"
